  ...
  Future<void> nextQuestion(id, urutan, jawaban) async {
    ...
    if (res.statusCode == 200) {
      ...
      setState(() {
        ...
        Navigator.of(context).pushReplacement(new MaterialPageRoute(builder: (context) => SliderDetail(id: nextId, urutanSoal: nextUrutan, message: message, email: email, jenis: jenis,)));
      });
    } else {
      info.messagesNoButton(context, 'info','Survey Error');
    }
  ...
  Future<void> prevQuestion(id, urutan, jawaban) async {
    ...
    if (res.statusCode == 200) {
      ...
      setState(() {
        ...
        message = nextQuest.message;
        Navigator.of(context).pushReplacement(new MaterialPageRoute(builder: (context) => SliderDetail(id: prevId, urutanSoal: prevUrutan, message: message, email: email, jenis: jenis,)));
      });
    } else {
      info.messagesNoButton(context, 'info','Survey Error');
    }
